...
(test-judgment-holds (run (((array int 2) arr)
                           ((pointer int) arrp)
                           ,(stmts->seq+term [
...
(test-judgment-holds (run ((int start)
                           (int count)
                           ,(stmts->seq+term [
                                              (= (start int) (19 int))
                                              (= (count int) (0 int))
                          ...
                          ((int 20)
                          ((0 (0 (int 1))) (1 (0 (int 20)))))))

(test-judgment-not-hold (run (((array int 1) arr)
                              ((pointer int) arrp)
                              ,(stmts->seq+term [
...
(test-judgment-holds (run ((int max)
                           (int i)
                           (int j)
                          ...
                          ((int 4)
                           ((0 (0 (int 4)))
                            (1 (0 (int 3)))
                            (2 (0 (int 3)))
                            (3 (0 (int 0)) (4 (int 0)) (8 (int 0)) (12 (int 0)) (16 (int 1)) (20 (int 2)) (24 (int 0)) (28 (int 2)) (32 (int 4)))
                            (4 (0 (ptr (3 0))))))
                          ))

(test-judgment-holds (run ((int lo)
                           (int hi)
                           (int mi)
                           (int target)
                           ((array int 10) arr)
                          ...
                          ((0 (0 (int 9)))
                           ...
                           (2 (0 (int 9)))
                           (3 (0 (int 1024)))
                           (4 (0 (int 20)) (4 (int 24)) (8 (int 50)) (12 (int 58)) (16 (int 95))
                              (20 (int 128)) (24 (int 572)) (28 (int 683)) (32 (int 934)) (36 (int 1024)))
                           (5 (0 (ptr (4 0))))))))

(define NodeT (term (struct Node (val int) (next (pointer void)))))
(test-judgment-holds (run ((,NodeT dummy)
                           (,NodeT n0)
                           (,NodeT n1)
                           (,NodeT n2)
                           (,NodeT n3)
                           ...
                           ,(stmts->seq+term [
                              (= (nullptr (pointer void)) ((& (nullptr (pointer void))) (pointer (pointer void))))
                              ; Linked List initialization
                              (= ((@ (dummy ,NodeT) next) (pointer void)) ((& (n0 ,NodeT)) (pointer void)))
                              (= ((@ (n0 ,NodeT) val) int) (1 int))
                              (= ((@ (n0 ,NodeT) next) (pointer void)) ((& (n1 ,NodeT)) (pointer void)))
                              (= ((@ (n1 ,NodeT) val) int) (2 int))
                              (= ((@ (n1 ,NodeT) next) (pointer void)) ((& (n2 ,NodeT)) (pointer void)))
                              (= ((@ (n2 ,NodeT) val) int) (3 int))
                              (= ((@ (n2 ,NodeT) next) (pointer void)) ((& (n3 ,NodeT)) (pointer void)))
                              (= ((@ (n3 ,NodeT) val) int) (4 int))
                              (= ((@ (n3 ,NodeT) next) (pointer void)) (nullptr (pointer void)))
                              ; Setup remove node
                              (= (toRemove int) (3 int))
                              ...
                              (while ((!= ((@ ((* (curr (pointer ,NodeT))) ,NodeT) next) (pointer void)) (nullptr (pointer void))) int)
                                     ,(stmts->seq+term [
                                        (if ((== (toRemove int) ((@ ((* (curr (pointer ,NodeT))) ,NodeT) val) int)) int)
                                            ...
                                            (= (prev (pointer void)) (curr (pointer void))))
                                        (= (curr (pointer void)) ((@ ((* (curr (pointer ,NodeT))) ,NodeT) next) (pointer void)))
                                        ]))
                              (return ((@ (dummy ,NodeT) next) (pointer void)))]))
                          ((ptr (1 0))
                           ((0
                             (0 undef)
                             (4 (ptr (1 0))))
